...
- **FR-004**: The README MUST include a Privacy section summarizing what usage sharing does and does not collect.
...
- **Help content**: Static text displayed inside the app, covering feature explanations. Friendly/tutorial tone. Not fetched from the network.
...
- `CONTRIBUTING.md` is out of scope; no separate contributing guide will be created.
